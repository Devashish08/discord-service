...
// DiscordSession provides a mock implementation of models.SessionInterface
// using testify/mock for use across different test packages.
...
func (m *DiscordSession) ApplicationCommandCreate(appID, guildID string, cmd *discordgo.ApplicationCommand) (*discordgo.ApplicationCommand, error) {
	...
	if args.Get(0) != nil {
		// Handle potential type mismatch during test setup
		var ok bool
